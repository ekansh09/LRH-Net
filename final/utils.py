...
#         class_sample_freqn = torch.sum(targets, dim =0 )
#         class_sample_freqn[class_sample_freqn==0] = 1
#         print('pos sample:',class_sample_freqn)
#         class_wts = 1 / class_sample_freqn         
#         pos_wts = (total_samples - class_sample_freqn) / class_sample_freqn
#         print('class_wt:',class_wts)
#         print('pos_wt:',pos_wts)


        class_sample_freqn = torch.FloatTensor(class_sample_freqn)
        class_wts = 1 / class_sample_freqn
        pos_wts = (total_samples - class_sample_freqn) / class_sample_freqn
        criterion = nn.BCEWithLogitsLoss(weight = class_wts.cuda(),reduction = 'none',pos_weight = pos_wts.cuda())
